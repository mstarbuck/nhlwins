...
#increase size
nhl_ann5 <- nnet(wins~., data=nhl_ann_train, size=10,rang=0.7,decay=5e-4,maxit=200)
...
#decrease size
nhl_ann6 <- nnet(wins~., data=nhl_ann_train, size=2,rang=0.7,decay=5e-4,maxit=200)
...
#increase maxit
nhl_ann7 <- nnet(wins~., data=nhl_ann_train, size=4,rang=0.7,decay=5e-4,maxit=300)
...
#increase decay
nhl_ann8 <- nnet(wins~., data=nhl_ann_train, size=4,rang=0.7,decay=0.5,maxit=300)
...
#adjust decay
nhl_ann9 <- nnet(wins~., data=nhl_ann_train, size=4,rang=0.7,decay=0.01,maxit=300)
...
#zero out decay
nhl_ann10 <- nnet(wins~., data=nhl_ann_train, size=4,rang=0.7,decay=0,maxit=300)
...
#using the parameters from nhl_ann3, retrain using the new data
nhl_ann_train <- nhl_num[ind==1,]
nhl_ann_test <- nhl_num[ind==2,]
nhl_ann11 <- nnet(wins~., data=nhl_ann_train, size=4,rang=0.7,decay=5e-4,maxit=200)
...
nhl_ann12 <- nnet(wins~., data=nhl_ann_train2, size=4,rang=0.7,decay=5e-4,maxit=200)
